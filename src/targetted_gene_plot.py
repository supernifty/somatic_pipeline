...
CLASSES=['frameshift_variant', 'stop_gained', 'stop_lost', 'start_lost', 'missense_variant', 'splice_donor_variant', 'splice_acceptor_variant', 'LOH', 'None'] # 0..8
COLORS=['#ff3030', '#ff60ff', '#ff90c0', '#ffc0c0', '#f0d070', '#7070ff', '#9050ff', '#70f070', '#e0e0e0']
